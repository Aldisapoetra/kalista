...
export default function Contact() {
  return (
    ...
    >
      <div className="from-ice/5 to-teal/70 grid gap-8 rounded-3xl border border-white/10 bg-linear-90 from-0% to-100% p-4 md:p-10 lg:grid-cols-2">
        <div>
        ...
        <div className="google-maps border-ice/20 h-full overflow-hidden rounded-3xl border-10">
          <iframe
