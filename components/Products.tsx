...
import CardProducts from "./cards/CardProduct";

export default function Products() {
  return (
    <section
      id="product"
      className="from-teal/10 to-teal/95 w-full bg-linear-90 from-0% to-100% py-24"
    >
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-20 text-center">
          ...
          <p className="text-lg text-white/60">
            Pilihan lengkap makanan beku berkualitas tinggi untuk segala
